...
## 10. Scope and size of changes

- Keep changes as small and focused as possible.
- Prefer minimal diffs over large rewrites.
- Only modify the parts of the file that are necessary for the current task.
- Do not create new files unless explicitly requested or clearly required.

When suggesting new code:

- Generate the smallest, self-contained snippet needed to implement the behavior.
- Avoid scaffolding large boilerplate blocks if they are not strictly needed.
- If a feature is large, propose splitting it into smaller steps and ask which part to implement first.

If I say “keep it minimal”, “small diff”, or “no big rewrites”, treat that as a hard constraint on how much code you output.

---

## 11. Response style for code suggestions
